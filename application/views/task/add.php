...
<?=form_open('task/add', array('id' => 'task_form')); ?>
	...
	<div class="row">
		<div class="form-group col-sm-6">
			...
			<input type="text" class="form-control" name="url" value="<?=set_value('url');?>" size="50" placeholder="<?php if($url_placeholder) {echo $url_placeholder;} else {echo 'https://www.youtube.com/watch?v=rtR2eJXb4U0';} ?>" />
		</div>
		<div class="form-group col-sm-6">
			<label for="name"><?php echo $this->lang->line('name'); ?></label>
			<input type="text" class="form-control" name="name" value="<?=set_value('name');?>" size="50" placeholder="<?=$this->lang->line('name_placeholder');?>" />
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="form-group col-sm-3">
			...
			<input type="text" class="form-control" name="hour_limit" value="<?=set_value('hour_limit');?>" size="15" placeholder="<?php echo $this->lang->line('hour_limit_tip'); ?>" />
		</div>
	</div>
	...
	<div class="form-group">
		<input type="submit" class="btn btn-success" value="<?php echo $this->lang->line('add_task'); ?>" />
	</div>
</form>
</div>